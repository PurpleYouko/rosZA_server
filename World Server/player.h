...
class CPlayer: public CCharacter
{
   ...
   //LMA: last shout.
    ...
    //Storage Expansion
    time_t timerexapnsion;
    bool storageExpanded;
    ...
    int wait_validation_ddrop;      //seems to be a pointless variable
    time_t timerddrop;
    int bonusddrop;
    bool once_ddrop;
	...
	clock_t lastGG;
	clock_t lastPacketSent;      // To check if player is afk
	...
	void UpdateInventoryCostume( unsigned int slot1, unsigned int slot2=0xffff, bool save=true);
    ...
    void clearquest( CPlayer* thisclient);
