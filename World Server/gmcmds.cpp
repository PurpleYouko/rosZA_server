...
bool CWorldServer::pakGMCommand( CPlayer* thisclient, CPacket* P )
{
   ...
   // *** RELOAD DATA FILES ******
    ...
    else if(strcmp(command, "serverdebug")==0)
    {
        //devs only
...
//		ADDSTRING( pak, "DELETESPAWN" );
    ...
    else if(strcmp(command, "qdrop")==0) // Sends a packet to the client to add/subtract a quest drop.
...
else if (strcmp(command,"readobjvar")==0) //PY code added to read values in NPC Object Variables (dialogs) Set access level very high
    {
...
else if (strcmp(command,"setobjvar")==0) //PY code added to set values in NPC Object Variables (dialogs) Set access level very high. Effects duplicate the event command
    {
...
//        if (i > 0 && i%10 == 0) {
	...
	else if (strcmp(command, "tdwave")==0) //create a wave of monsters in current map
	{
        if(thisclient->Session->accesslevel < 900) //DEV only
	        return true;
    ...
    else if (strcmp(command, "tdspawnrate")==0) //create a wave of monsters in current map
	{
         if(thisclient->Session->accesslevel < 900) //DEV only
	        return true;
...
//         }
    ...
    else if (strcmp(command,"setwp")==0)  //PY new waypoint system added
    {
        // SYNTAX::  /setwp[wptype]
    ...
    }else if(strcmp(command, "warning")==0){  // warning command
	...
	}else if(strcmp(command, "warningcount") == 0){

	    return pakWarningCount(thisclient);

    }else if(strcmp(command, "warningreason") ==0){

        return pakWarningReason(thisclient);

    }else if(strcmp(command, "seewarning") == 0){
    ...
    }else if(strcmp(command,"delwarning")==0){
    ...
    }else if (strcmp(command, "ticket")==0) // Submit ticket
    {
        char ticketTest[200];
        char date[9];
    ...
    else if (strcmp(command, "deltick")==0) // Delete Ticket
    {
    ...
    else if (strcmp(command, "readtick")==0) // Read Tickets
    {
    ...
    else if (strcmp(command, "time")==0) // show time
    {
        time_t rawtime;
        struct tm * timeinfo;
    ...
    else if (strcmp(command, "happyhour")==0) // show hh map
    {
    ...
    else if (strcmp(command, "hhexp")==0) // change hh exp
    {
    ...
    else if(strcmp(command, "hhOn")==0) // Activate HH
    {
    ...
    else if(strcmp(command, "lottobegin")==0)
    {
    ...
    else if(strcmp(command, "lottostart")==0)
    {
        if(GServer->Config.Command_Lotto > thisclient->Session->accesslevel || thisclient->CharInfo->isGM == false)
        {
    ...
    else if(strcmp(command, "lotto")==0)
    {
    ...
    else if(strcmp(command, "lottohelp")==0)
    {
    ...
    else if(strcmp(command, "lottor")==0)
    {
        int GuessNumber[6]={0,0,0,0,0,0};
        char Guess[100];
        int DonationPoints;
    ...
    else if(strcmp(command, "vinfo")==0)
    {
        int number;
        if ((tmp = strtok(NULL, " ")) == NULL)
        {
