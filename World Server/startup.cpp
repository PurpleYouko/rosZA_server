...
bool CWorldServer::LoadMonsterSpawn( )
{
	...
	while(row = mysql_fetch_row(result))
    {
		...
		//if(count > 10780)
        //    Log( MSG_INFO, "checking spawn %i", count );
		for(int i=1;i==5;i++)
        {
        ...
        //if(count > 10780)
        //    Log( MSG_INFO, "checking spawn %i checked bmobs", count );
        for(int i=1;i==2;i++)
        {
        ...
        //if(count > 10780)
        //    Log( MSG_INFO, "checking spawn %i checked tmobs", count );
        ...
        count++;
        //if(count > 10780)
        //    Log( MSG_INFO, "checking spawn %i ready to push to mapslist", count );
        //if( count < 10785 )
        //{
            //if(count > 10780)
            //    Log( MSG_INFO, "checking spawn %i ready to push to mapslist", count );
            ...
            //if(count > 10780)
            //    Log( MSG_INFO, "checking spawn %i pushed up just fine", count );
        //}
	}
	Log( MSG_INFO, "finished all the spawn rows" );
	DB->QFree( );
...
bool CWorldServer::LoadEquip( )
{
    ...
    for(int j=0;j<9;j++)
    {
        for(unsigned int i=0;i<STB_ITEM[j].rowcount;i++)
        {
            ...
            newequip->acc = STB_ITEM[j].rows[i][30];
